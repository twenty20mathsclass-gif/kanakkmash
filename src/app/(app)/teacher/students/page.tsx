...
export default function TeacherStudentsPage() {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const usersCollection = query(collection(firestore, 'users'), where('role', '==', 'student'));
  ...
  const filteredUsers = useMemo(() => {
    return users.filter(user => {
        ...
        return matchesSearch && matchesClass && matchesSyllabus && matchesExam && matchesLevel;
    });
  }, [users, searchTerm, selectedClass, selectedSyllabus, selectedExam, selectedLevel]);
          ...
          <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Search, filter, and manage all students.</p>
                </div>
              </div>
              <AddUserDialog creatorRole="teacher" onUserAdded={fetchUsers} />
          </div>
        </Reveal>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>A filtered list of students matching your criteria.</CardDescription>
              </div>
            ...
            <CardContent>
                {loading ? (
                  ...
                  <UsersTable users={filteredUsers} onUserUpdated={fetchUsers} baseHref="/teacher/students" />
                )}
            </CardContent>
          </Card>
        </Reveal>
