...
export function SchedulingActivityChart({ schedules }: { schedules: Schedule[] }) {
        ...
        return (
            <Card className="shadow-lg">
                <CardHeader>
                    ...
                    <CardDescription>Platform-wide class and exam schedule activity for the last 4 weeks.</CardDescription>
                </CardHeader>
